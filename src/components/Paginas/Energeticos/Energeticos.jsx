...
import 'swiper/css';
import './Energeticos.css'; // se precisar de estilos específicos

const Energetico = () => {
  const [produtos, setProdutos] = useState([]);
  const [filtro, setFiltro] = useState('');
  const [categoriaFiltro, setCategoriaFiltro] = useState('ENERGETICOS');
  ...
  return (
    <div className="container-banner">
      ...
      <div className="swiper-container">
        ...
        >
          {categoriasEnergetico.map((categoria, index) => (
