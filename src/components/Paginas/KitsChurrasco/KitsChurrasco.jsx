...
const BotaoAdicionarKit = ({ kitInfo }) => {
  ...
  if (itemNoCarrinho) {
    return (
      <div className="quantity-control-kit">
        ...
        <button onClick={() => adicionarAoCarrinho({ ...kitInfo, id: kitId })}>
          +
        </button>
      </div>
    );
  ...
  return (
    <button
      className="kit-add-button"
      onClick={() => adicionarAoCarrinho({ ...kitInfo, id: kitId })}
    >
...
const KitsDeChurrasco = () => {
  const kit1Itens = [
    ...
    { nome: "Coxinha da Asa (1)", imagem: CoxinhaDaAsa },
    { nome: "Linguiça (1)", imagem: Linguiça },
