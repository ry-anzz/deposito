...
import 'swiper/css';
import './Gelos.css'; // se precisar de estilos específicos

const Gelos = () => {
  const [produtos, setProdutos] = useState([]);
  const [filtro, setFiltro] = useState('');
  const [categoriaFiltro, setCategoriaFiltro] = useState('GELO');
  ...
  return (
    <div className="container-banner">
      ...
      <div className="swiper-container">
        ...
        >
          {categoriasGelos.map((categoria, index) => (
