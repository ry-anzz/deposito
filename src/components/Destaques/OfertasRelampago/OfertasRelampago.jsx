      ...
      try {
        ...
        if (data) {
          ...
          const ofertasSimuladas = data.map((produto, index) => {
            ...
            const fimDaOferta = new Date(agora.getTime() + ((index + 1) * 2 * 60 * 60 * 1000 + 15 * 60 * 1000)); // 2h15m, 4h15m, etc.
  ...
  return (
    <div className="oferta-relampago-container">
      <div className="oferta-header">
        ...
        {produtoPrincipal && <CountdownTimer targetDate={produtoPrincipal.fim_oferta} />}
      </div>
